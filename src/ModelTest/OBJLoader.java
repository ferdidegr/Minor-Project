...
public class OBJLoader {
	public static Model loadModel(File f) throws FileNotFoundException, IOException {
		...
		Model m = new Model();
		String line;
		while ((line = reader.readLine()) != null) { // reads file line by line, quits after final line
			if (line.startsWith("v")) {
				float x = Float.valueOf(line.split(" ")[1]); // splits lines in every place where there's a space
