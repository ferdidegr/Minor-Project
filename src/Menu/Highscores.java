...
int FontSize, Fontheight;
	...
	public void display(){	
		...
		for(int i = 1 ; i < playername.size();i++){Menu.mainfont.draw(Display.getWidth()*1/2, i*Fontheight, FontSize, playername.get(i));}
		...
		Menu.mainfont.draw(Display.getWidth()*1/2, 0, FontSize, playername.get(0));
